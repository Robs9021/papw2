                 ...
                 <nav class="navbar navbar-default">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Cursos <span class="glyphicon glyphicon-triangle-bottom"></span></a>
                                <ul class="dropdown-menu">
                                    <!-- If user has no courses, just show a link to cousrses catalog -->
                                    <li>
                                        <a href="#">Nombre curso</a>
                                        <ul>
                                            <li>Nombre Módulo</li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Inscribir curso</a></li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <div class="nav navbar-nav navbar-right">
                            ...
                            <a class="navbar-important" href="#">Alumno</a>
                        </div>
                    </div>
                </nav>
            @show
